...
# Burrito.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :burrito, Burrito.Web.Endpoint,
  on_init: {Burrito.Web.Endpoint, :load_from_system_env, []},
  url: [host: "hack.bessey.io", port: 80],
...
# start per endpoint:
#
#     config :burrito, Burrito.Web.Endpoint, server: true
#
